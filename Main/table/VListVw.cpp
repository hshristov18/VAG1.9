...
HINSTANCE   g_hInst;
TCHAR       g_textClassName[] = TEXT("VListVwClass");

#define ITEM_COUNT   100
int WINAPI WinTable(HINSTANCE hInstance,
...
BOOL InitApplication(HINSTANCE hInstance)
{
	...
	wcex.lpszClassName = g_textClassName;
	...
	if (0 == aReturn)
	{
		...
		wc.lpszClassName = g_textClassName;
	...
	LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDM_ABOUT:
			DialogBox(g_hInst, MAKEINTRESOURCE(IDD_ABOUT), hWnd, AboutDlgProcTable);
			break;
...
INT_PTR CALLBACK AboutDlgProcTable(HWND hDlg,
	UINT uMessage,
	WPARAM wParam,
	LPARAM lParam)
{
...
void ErrorHandlerEx(WORD wLine, LPSTR lpszFile)
{
	...
	MessageBox(NULL, (LPCSTR)lpvMessage, szBuffer, MB_ICONEXCLAMATION | MB_OK);
}
